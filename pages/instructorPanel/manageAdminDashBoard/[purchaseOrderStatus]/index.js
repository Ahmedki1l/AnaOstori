...
//             const date = dayjs(selectedStartDate).add(i, 'day').format('YYYY-MM-DD')
//             labels.push(date)
//             const total = data?.filter(order => formatedDate(order.createdAt) === date).reduce((acc, order) => {
//                 return acc + order.totalPrice
//             }, 0)
//             totalEarnings.push(total)
//         }
//     } else if (selectedDate !== undefined) {
//         if (dayjs(selectedEndDate).diff(dayjs(selectedStartDate), 'day') > 2 && dayjs(selectedEndDate).diff(dayjs(selectedStartDate), 'day') < 31) {
//             for (let i = 0; i < dayjs(selectedEndDate).diff(dayjs(selectedStartDate), 'day') + 1; i++) {
//                 const date = dayjs(selectedStartDate).add(i, 'day').format('YYYY-MM-DD');
//                 labels.push(date);
//                 const total = data?.filter(order => formatedDate(order.createdAt) === date).reduce((acc, order) => {
...
//             }
//         }
//         if (dayjs(selectedEndDate).diff(dayjs(selectedStartDate), 'day') > 31) {
//             for (let i = 0; i < 31; i++) {
//                 const date = dayjs(selectedStartDate).add(i, 'day').format('YYYY-MM-DD')
//                 console.log('more then one month', date);
//                 labels.push(date)
//                 const total = data?.filter(order => formatedDate(order.createdAt) === date).reduce((acc, order) => {
//                     return acc + order.totalPrice
//                 }, 0)
...
//         chartId: 'lineChartForSuccessOrders',
//         labels: labels,
//         datasets: {
//             label: 'My First Dataset',
//             data: totalEarnings,
...
//         },
//     };
//     setOrderDataForLineChart(dataForLineChart);
// };