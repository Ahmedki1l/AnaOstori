    ...
    return (
        <div className='maxWidthDefault'>
            ...
            <div className='flex flex-wrap p-4'>
                ...
                <Link href={'/instructorPanel/manageCustomeCoursesOrders'} className={`${styles.dashboardItemWrapper} normalLinkText`}>
                    <AllIconsComponenet width={39} height={39} iconName='manageCoupons' color={'#000000'} />
                    <p className={`fontMedium ${styles.dashboardItemName}`}>إدارة طلبات الدورات الخاصة</p>
                </Link>
                ...
                <Link href={'/instructorPanel/manageBlogs'} className={`${styles.dashboardItemWrapper} normalLinkText`}>
                    <AllIconsComponenet width={39} height={39} iconName='manageCoupons' color={'#000000'} />
                    <p className={`fontMedium ${styles.dashboardItemName}`}>إدارة المدونات</p>
                </Link>
                <Link href={'/instructorPanel/manageExamResults'} className={`${styles.dashboardItemWrapper} normalLinkText`}>
                    <AllIconsComponenet width={39} height={39} iconName='quiz' color={'#000000'} />
                    <p className={`fontMedium ${styles.dashboardItemName}`}>إدارة نتائج الاختبارات</p>
                </Link>
                <Link href={'/instructorPanel/manageQRCodes'} className={`${styles.dashboardItemWrapper} normalLinkText`}>
                    <AllIconsComponenet width={39} height={39} iconName='manageCoupons' color={'#000000'} />
