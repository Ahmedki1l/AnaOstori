...
//                                 <td>
//                                     <div className={styles.videoFolderList} onClick={() => showItemListOfSelectedFolder(item)}>
//                                         <AllIconsComponenet iconName={'squareIcon'} height={18} width={18} color={'#000000'} />
//                                         <p className={`cursor-pointer ${styles.numberOfAddedVideoNames}`}>{'curriculum1'}</p>
//                                         <p className={styles.numberOfAddedVideo}>{` (23  عنصر / عناصر  )`}</p>
//                                     </div>
//                                 </td>
//                                 <td>{fullDate('12/6/23')}</td>
//                                 <td>{fullDate('5/9/24')}</td>
//                                 <td>دورة القدرات الحضورية</td>
//                                 <td>
//                                     <div className={styles.videoeventButtons}>
//                                         <div className='cursor-pointer' onClick={() => onEdit(item)}>
