...
const GoogleMapsIcon = () => (
  ...
  >
    ...
    <path
      fill="#0F9D58"
      d="M2553.316 3090.856l2268.569-2535.46c-37.479-11.6-77.248-17.856-118.408-17.856H403.155C181.42 537.54 0 718.96 0 940.695v4300.322c0 41.16 6.257 80.929 17.856 118.408l2535.46-2268.569z"
    />
    <path
      fill="#4285F4"
      d="M2553.316 3090.856L284.747 5626.316c37.479 11.6 77.248 17.856 118.408 17.856h4300.322c41.16 0 80.929-6.256 118.408-17.856l-2268.569-2535.46z"
    />
    <path
      fill="#D2D2D2"
      d="M2553.316 3090.856l2535.46 2268.569c11.6-37.479 17.856-77.248 17.856-118.408V940.695c0-41.16-6.257-80.929-17.856-118.408l-2535.46 2268.569z"
    />
    <path
      fill="#F1F1F1"
      d="M5106.633 5241.018L2687.701 2822.086l-470.348 403.155 2418.931 2418.931h67.192c221.737.001 403.157-181.419 403.157-403.154z"
    />
    <path
      fill="#FFDE48"
      d="M4703.478 537.54L0 5241.018c0 221.736 181.42 403.155 403.155 403.155h67.193l4636.285-4636.285v-67.193c0-221.735-181.42-403.155-403.155-403.155z"
    />
    <path
      fill="#FFF"
      fillOpacity=".2"
      d="M4703.478 537.54H403.155C181.42 537.54 0 718.96 0 940.695v33.596c0-221.735 181.42-403.155 403.155-403.155h4300.322c221.735 0 403.155 181.42 403.155 403.155v-33.596c.001-221.735-181.419-403.155-403.154-403.155z"
    />
    <path
      fill="#263238"
      fillOpacity=".1"
      d="M4703.478 5610.577H403.155C181.42 5610.577 0 5429.157 0 5207.421v33.596c0 221.736 181.42 403.155 403.155 403.155h4300.322c221.735 0 403.155-181.419 403.155-403.155v-33.596c.001 221.736-181.419 403.156-403.154 403.156z"
    />
    <path
      fill="#EEE"
    ...
    <use
      ...
      filter="url(#b)"
      opacity=".25"
      style={{ transform: "scaleX(.625) translateX(50.4%)" }}
    />
    <use href="#m" />
    ...
    <path
      fill="#FFF"
      fillOpacity=".2"
      d="M4300.322 33.596c735.758 0 1333.1 591.294 1343.179 1324.365 0-4.703.672-9.407.672-14.11C5644.173 601.373 5042.8 0 4300.322 0s-1343.85 601.373-1343.85 1343.851c0 4.703.672 9.407.672 14.11 10.078-733.07 607.42-1324.365 1343.178-1324.365z"
    />
    <path
      fill="#3E2723"
      fillOpacity=".2"
      d="M4379.609 4295.619c-3.36 40.315-38.3 71.896-79.287 71.896s-75.927-31.581-79.287-71.896C4088.666 2857.027 2967.894 2327.55 2957.144 1324.365c0 6.719-.672 12.767-.672 19.486 0 1012.591 1130.85 1540.053 1264.564 2985.364 4.031 40.315 38.3 71.896 79.287 71.896s75.927-31.581 79.287-71.896c133.712-1445.312 1264.563-1972.773 1264.563-2985.364 0-6.719-.672-12.767-.672-19.486-10.751 1003.184-1130.851 1533.333-1263.892 2971.254z"
    />
    <radialGradient
      id="r"
      cx="140.0966"
      cy="5533.9414"
      r="6883.6064"
      gradientTransform="matrix(1 0 0 -1 0 6182.7524)"
        ...
        <div className="maxWidthDefault relative">
          {screenWidth > 767 && (
            <div className={styles.pathDiv}>
              ...
              <Link href={`/${courseCatagoriUrl}`} className={styles.pathText}>
                {courseDetail.catagory.name}
              </Link>
              <div className={styles.arrowIcon}>
                {lang == "en" ? (
                  <AllIconsComponenet
          ...
          {!(screenWidth > 767) && (
            <div className={`w-80 mx-auto ${styles.courseImgWrapper}`}>
              <CoverImg
                height={190}
                url={
                  courseDetail.pictureKey
                    ? mediaUrl(
                        courseDetail.pictureBucket,
                        courseDetail.pictureKey
                      )
          ...
          <p className={styles.courseDiscriptionText}>
            {courseDetail.shortDescription}
          </p>
          <div className={styles.analyticsBarWrapper}>
            {courseDetail.type == "physical" ? (
              <div
                className={`${styles.analyticsCard} pt-8 ${
                  lang == "en" ? "pr-8" : "pl-8"
                }`}
              >
                <div className="m-1">
                  <AllIconsComponenet
                    height={isMediumScreen ? 18 : 32}
                    width={isMediumScreen ? 20 : 32}
                    iconName={"locationDoubleColor"}
                    color={"#FFFFFF"}
                  />
                </div>
                <div className="px-1">
              ...
              >
                <div className="mt-2">
                  <AllIconsComponenet
                    height={isMediumScreen ? 18 : 32}
                    width={isMediumScreen ? 20 : 32}
                    iconName={"onlineDoubleColorIcon"}
                    color={"#FFFFFF"}
                  />
                </div>
                <div className="px-1">
              ...
              >
                <div className="mt-2">
                  <AllIconsComponenet
                    height={isMediumScreen ? 18 : 20}
                    width={isMediumScreen ? 20 : 22}
                    iconName={"newLiveTVIcon"}
                    color={"#FFFFFF"}
                  />
                </div>
                <div className="px-1">
            ...
            <div className={`${styles.analyticsBarWrapper2}`}>
              {courseDetail.reviewRate !== "-" && (
                ...
                >
                  <div className="m-1">
                    <AllIconsComponenet
                      height={isMediumScreen ? 18 : 24}
                      width={isMediumScreen ? 20 : 24}
                      iconName={"starDoubleColoredIcon"}
                      color={"#FFCD3C"}
                    />
                  </div>
                  <div className="px-1">
              ...
              {courseDetail.numberOfGrarduates !== "-" && (
                <div
                  className={`${styles.analyticsCard} pt-8 ${
                    lang == "en" ? "pr-8" : "pl-8"
                  }`}
                >
                  <div className="m-1">
                    <AllIconsComponenet
                      height={isMediumScreen ? 18 : 22}
                      width={isMediumScreen ? 20 : 22}
                      iconName={"personDoubleColoredIcon"}
                      color={"#FFFFFF"}
                    />
                  </div>
                  <div className="px-1">
                    {courseDetail.type == "onDemand" ? (
                      <p>
                        {lang == "en"
                          ? "Number of graduates subscriptions "
                          : "عدد الاشتراكات"}
                      </p>
                    ) : (
                      <p>
                        {lang == "en" ? "Number of graduates" : "عدد المسجلين"}{" "}
                      </p>
                    )}
                    <p className="fontBold">
                      {courseDetail.numberOfGrarduates}
          ...
          {screenWidth > 767 &&
            offset <
              (screenWidth > 1280 ? 357 : screenWidth < 1024 ? 313 : 336) && (
              <BuyCourseComponent
