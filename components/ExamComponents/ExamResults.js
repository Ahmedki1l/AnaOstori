                        ...
                        <div className={styles.statsTopRow}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 32 32" fill="none">
                                <g clipPath="url(#clip0_198_6381)">
                                    ...
                                    <path d="M14.6666 9.33268H17.3333V11.9993H14.6666V9.33268ZM14.6666 14.666H17.3333V22.666H14.6666V14.666ZM15.9999 2.66602C8.63993 2.66602 2.6666 8.63935 2.6666 15.9993C2.6666 23.3593 8.63993 29.3327 15.9999 29.3327C23.3599 29.3327 29.3333 23.3593 29.3333 15.9993C29.3333 8.63935 23.3599 2.66602 15.9999 2.66602ZM15.9999 26.666C10.1199 26.666 5.33326 21.8793 5.33326 15.9993C5.33326 10.1193 10.1199 5.33268 15.9999 5.33268C21.8799 5.33268 26.6666 10.1193 26.6666 15.9993C26.6666 21.8793 21.8799 26.666 15.9999 26.666Z" fill="black" fillOpacity="0.2" />
                                </g>
                                <defs>
                                ...
                                <td className={styles.timer}>
                                    <div style={{ width: '28px', height: '28px' }} >
                                        <svg width="20" height="20" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clipPath="url(#clip0_207_14210)">
